...
export default async function LivePage() {
  ...
  return (
    <section className="section-shell section-space">
      <FadeIn className="overflow-hidden rounded-[2.25rem] border border-white/8 bg-[radial-gradient(circle_at_top_left,rgba(214,185,140,0.12),transparent_30%),linear-gradient(180deg,rgba(255,255,255,0.03),rgba(255,255,255,0.01))] px-7 py-9 shadow-luxury sm:px-10 sm:py-10 lg:px-12">
        <div className="grid gap-8 lg:grid-cols-[minmax(0,1fr)_auto] lg:items-end">
          <div>
            ...
            <h1 className="mt-7 max-w-5xl text-5xl leading-[0.86] text-white sm:text-6xl lg:text-7xl">
              O pagina LIVE care arata ca o platforma reala de streaming.
            </h1>
